...
public class Receive {
    ...
    static {
        ...
        properties.setProperty(ClientConfig.XIMQ_GROUP_ID, "group-consumer-receive");
    }
    public static void main(String[] args) {
        Consumer consumer = new Consumer(properties);
        consumer.subscribe(Collections.singleton("topics"), new RecordFuture() {
            @Override
            public void callback(Response response) {
                System.out.println("【Consumer receive Message】-> " + StringUtils.getString(response));
            }
        });
    }
}
